...
def load_and_prepare_data(file_path):
    ...
    # 数据验证
    required_columns = ['Cgla_c1c2', 'year', 'Sal', 'MLDaverSST', 'SST', 'SIC', 'mlotst_glor', 'MLDaverSal']
...
def main():
    """主函数"""
    # 配置参数
    data_path = "Cgla_c1c2_mldaver.csv"
    output_path = "E:/ECNU/20250721/responseCurve_Cgla.jpg"
