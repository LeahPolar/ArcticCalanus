...
# ... existing code ...
with rasterio.open(os.path.join(output_path, "CglaSuitability1993-2007mean.tif"), 'w',
...
with rasterio.open(os.path.join(output_path, "CglaSuitability2008-2022mean.tif"), 'w',
                   driver='GTiff', dtype=rasterio.float32,
...
with rasterio.open(os.path.join(output_path, "CglaSuitability2008-2022minus1993-2007.tif"), 'w',
                   driver='GTiff', dtype=rasterio.float32,
...
with rasterio.open(os.path.join(output_path, "CglaSuitability1993-2022mean.tif"), 'w',
                   driver='GTiff', dtype=rasterio.float32,
